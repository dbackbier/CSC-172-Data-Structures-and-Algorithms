...
public class URLLTest {
    public static void main(String[] args) {
        ...
        System.out.println("Contains all [10, 20, 30, 40, 50, 60] is " + list.containsAll(Arrays.asList(10, 20, 30, 40, 50, 60))); // expect: false
    
        // Test equals(Object o)
        URLinkedList<Integer> list2 = new URLinkedList<>();
        ...
        System.out.println("Sublist of list2 from index 6 to 7: " + Arrays.toString(subList1.toArray())); // expect: [30]
        System.out.println("Sublist of list2 from index 4 to end: " + Arrays.toString(subList2.toArray()) + "\n"); // expect: [15, 20, 30, 40, 50, 11]

        // Test addFirst(elem e)
        list.addFirst(10);
        // Test addLast(elem e)
        list.addLast(50);
        System.out.println("Elements after addFirst(10) and addLast(50): " + Arrays.toString(list.toArray())); // expect: [10, 20, 40, 50]

        // Test peekFirst()
        System.out.println("Peek first element: " + list.peekFirst()); // expect: 10
        // Test peekLast()
        System.out.println("Peek last element: " + list.peekLast() + "\n"); // expect: 50

        // Test pollFirst()
        System.out.println("Poll first element: " + list.pollFirst()); // expect: 10
        // Test pollLast()
        System.out.println("Poll last element: " + list.pollLast()); // expect: 50
        System.out.println("Elements after polling first and last: " + Arrays.toString(list.toArray()) + "\n"); // expect: [20, 40]
    }
}
